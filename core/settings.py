...
FACEBOOK_OAUTH_AUTHORIZE_URL = os.getenv('FACEBOOK_OAUTH_AUTHORIZE_URL')
FACEBOOK_OAUTH_TOKEN_URL = os.getenv('FACEBOOK_OAUTH_TOKEN_URL')
...
LINKEDIN_AUTHORIZE_URL = os.getenv('LINKEDIN_AUTHORIZE_URL')
